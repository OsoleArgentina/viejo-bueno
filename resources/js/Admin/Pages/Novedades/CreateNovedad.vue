<template>
    ...
    <div  class="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
        <div class="bg-white rounded-lg p-6 w-1/2 modal-animation">
            <h2 class="text-2xl font-semibold mb-4">Crear novedad</h2>
            ...
            <div class="w-full">
                ...
                <div class="flex justify-end space-x-2">
                    ...
                    <button @click="create_novedad" class="px-4 py-2 bg-theme-400 text-white rounded-md duration-300 hover:bg-theme-600 cursor-pointer">Guardar</button>
                </div>
            </div>
        </div>
    </div>
...
export default {
    ...
    methods: {
        ...
        create_novedad() {
            ...
            this.emit_event('create_novedad', data);
        },
    },
};
</script>
