        ...
        <div class="bg-white rounded-lg p-6 w-96 modal-animation">
            ...
            <div>
                ...
                <div class="mb-4">
                    ...
                    <span class="text-xs text-neutral-400">Resolucion sugerida 1,024 x 712</span>
                ...
                <div class="flex justify-end space-x-2">
                    ...
                    <button @click="editar_slider" class="px-4 py-2 bg-theme-400 text-white rounded-md duration-300 hover:bg-theme-600 cursor-pointer">Actualizar</button>
                </div>
            </div>
        </div>
    </div>
