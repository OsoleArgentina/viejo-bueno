        ...
        <div class="bg-white rounded-lg p-6 w-96 modal-animation">
            ...
            <div>
                ...
                <div class="flex justify-end space-x-2">
                    ...
                    <button @click="crear_elegirnos" class="px-4 py-2 bg-theme-400 text-white rounded-md duration-300 hover:bg-theme-600 cursor-pointer">Guardar</button>
                </div>
            </div>
        </div>
    </div>
...
export default {
    ...
    methods: {
        ...
        crear_elegirnos() {
            ...
            this.emit_event('crear_elegirnos', data);
        },
    },
};
</script>
